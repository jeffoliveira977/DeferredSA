...
std::list<CPed*> VisibilityPlugins::ms_weaponPeds = {};

void VisibilityPlugins::RenderWeaponPedsNoMuzzleFlash()
{
   /* for(CPed* pedWithWeapon : ms_weaponPeds)
        RenderWeaponsForPed(pedWithWeapon);*/
}

void VisibilityPlugins::RenderWeaponsForPed(CPed* pedWithWeapon)
{
...
void VisibilityPlugins::AddPedWithWeapons(CPed* ped)
{
    ms_weaponPeds.push_back(ped);
}

void VisibilityPlugins::ClearWeaponPedsList()
{
    ms_weaponPeds.clear();
}

void VisibilityPlugins::Patch()
{
    plugin::patch::RedirectCall(0x5E7859, AddPedWithWeapons);
}

void VisibilityPlugins::DisableGunFlashAlpha(CPed* ped)
{

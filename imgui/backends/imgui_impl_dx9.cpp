...
static void ImGui_ImplDX9_SetupRenderState(ImDrawData* draw_data)
{
    ...
    bd->pd3dDevice->SetSamplerState(0, D3DSAMP_MINFILTER, D3DTEXF_GAUSSIANQUAD);
    bd->pd3dDevice->SetSamplerState(0, D3DSAMP_MAGFILTER, D3DTEXF_GAUSSIANQUAD);
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
               ...
               /* const LPDIRECT3DTEXTURE9 texture = (LPDIRECT3DTEXTURE9)pcmd->GetTexID();
                ...
                RwRaster* tex = (RwRaster*)pcmd->TextureId;
                if(tex /*&& tex->raster*/)
                {
                    RwRenderStateSet(rwRENDERSTATETEXTURERASTER, tex);
                    /*              RwRenderStateSet(rwRENDERSTATETEXTUREADDRESS, (void*)RwTextureGetAddressing(tex));
                    ...
                    RwRenderStateSet(rwRENDERSTATETEXTUREADDRESS, (void*)rwTEXTUREADDRESSNATEXTUREADDRESS);
...
static bool ImGui_ImplDX9_CreateFontsTexture()
{
    ...
    //bd->FontTexture = NULL;
    //if (bd->pd3dDevice->CreateTexture(width, height, 0, D3DUSAGE_DYNAMIC, D3DFMT_A8R8G8B8, D3DPOOL_DEFAULT, &bd->FontTexture, NULL) < 0)
    //    return false;
    ...
    g_FontTexture2 = raster;
    /*  RwTextureSetFilterMode(g_FontTexture, rwFILTERLINEAR);
      RwTextureSetAddressing(g_FontTexture, rwTEXTUREADDRESSBORDER);*/

    RwImageDestroy(image);

    // Store our identifier
    io.Fonts->SetTexID((ImTextureID)g_FontTexture2);
